        ...
        <section class="main__session">
            ...
            <article class="main__session__form">
                <div class="main__session__form__tab">
                    <a class="main__session__form__tab__link" :class="{ main__session__form__tab__link__active: session }"
                        href="#" @click="listenSession">INICIAR SESIÓN</a>
                    <a class="main__session__form__tab__link" :class="{ main__session__form__tab__link__active: !session }"
                        href="#" @click="listenSession">REGISTRARSE</a>
                </div>
                <form v-if="session" class="main__session__form__signin" @submit.prevent="">
                    ...
                    <div class="main__session__form__signin__field">
                        ...
                        <input class="main__session__form__signin__field__input" :type="visibility ? 'text' : 'password'"
                ...
                <form v-if="!session" class="main__session__form__signin" @submit.prevent="">
                    ...
                    <div class="main__session__form__signin__field">
                        ...
                        <input class="main__session__form__signin__field__input" type="text" placeholder="Nombre de usuario"
                            aria-label="username" />
                    </div>
                    <div class="main__session__form__signin__field">
                        <span class="main__session__form__signin__field__icon material-symbols-sharp">lock</span>
